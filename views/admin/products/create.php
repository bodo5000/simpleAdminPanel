        ...
        <form method="post" action="/cars/store" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="carCode" placeholder="Enter CarCode" name="code">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="carName" placeholder="Enter CarName" name="name">
                ...
                <div class="form-group d-flex">
                    ...
                    <textarea name="description" id="description" cols="200" rows="10" placeholder="description"></textarea>
